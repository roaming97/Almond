...
![](app/static/almond.png)

Video database app made with Python using [Flask](https://flask.palletsprojects.com/en/2.3.x/).

---

## Installing

To run this application you require at least [Python 3.8](https://www.python.org/downloads/) and [ffmpeg](https://ffmpeg.org/download.html) installed on your computer or server.
...
Clicking the _Quick add_ button and inserting a YouTube URL should be enough,
there is an option to add videos via local files with the _Manual Add_ button.
